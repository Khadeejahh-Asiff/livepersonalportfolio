      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
            ...
            web applications using React.js, Next.js, and Tailwind CSS. Through
            real-world projects and industry roles, I’ve honed skills in
            performance optimization, UI design, and collaborative development
            in Agile teams.
          </p>
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Colored top bar */}
                    <div
                      className={`h-1.5 w-full ${gradientColors.accent}`}
                    ></div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div
                          className={`p-3 rounded-lg ${theme === "light" ? "bg-white/70" : "bg-gray-800/70"} backdrop-blur-sm shadow-sm`}
                        >
